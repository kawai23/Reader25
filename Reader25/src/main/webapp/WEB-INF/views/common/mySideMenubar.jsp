...
<!-- 	  <img src=""> -->
		  ...
		  <p style="margin-left: 70px; color: white;"  href="myPointList.me">포인트 : 
		   <a style=" color: white;"  href="myPointList.me"> ${loginUser.point }</a> <hr>
						...
						<a href="myPointList.me" class="list-group-item" id="point">포인트 내역</a> 
						...
						<a href="myList.me?code=3" class="list-group-item"  id="c3">책방 목록</a>
						<a href="myPayList.me" class="list-group-item"  id="pay">주문 조회</a>
